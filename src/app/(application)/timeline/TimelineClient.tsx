...
// Lazy-load views (reduces initial bundle)
const DayTimelineView = dynamic(
  () => import("@/components/timeline/views/DayTimelineView"),
  { ssr: false },
);
const WeekTimelineView = dynamic(
  () => import("@/components/timeline/views/WeekTimelineView"),
  { ssr: false },
);
const MonthTimelineView = dynamic(
  () => import("@/components/timeline/views/MonthTimelineView"),
  { ssr: false },
);
