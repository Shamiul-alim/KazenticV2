    ...
    <div className="min-h-screen flex flex-col justify-between bg-white px-6 py-8">
      ...
      <div>
        ...
        <div className="flex items-center">
          <button onClick={next} disabled={step === 1} className="p-2 rounded-full hover:bg-gray-100 transition">
            <ArrowLeft className="w-5 h-5 text-gray-700" />
          </button>
        </div>

        {/* Center Content */}
        <div className="flex flex-col items-center justify-start text-center max-w-2xl mx-auto">

          {/* Logo */}
          <div className="w-16 h-16 rounded-xl bg-blue-600 flex items-center justify-center mb-6 shadow-md">
