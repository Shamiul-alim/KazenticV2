    ...
    <Card title="Bank Information">
      <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2">
        <BankInfoItem
          icon={Landmark}
          label="Bank Name"
          value={defaultUserInfo.bankName}
        />
        <BankInfoItem
          icon={Building2}
          label="Branch Name"
          value={defaultUserInfo.branchName}
        />
        <BankInfoItem
          icon={User}
          label="Account Holder name"
          value={defaultUserInfo.accountHolderName}
        />
        <BankInfoItem
          icon={Hash}
          label="Account Number"
          value={defaultUserInfo.accountNumber}
        />
        <BankInfoItem
          icon={Hash}
          label="Routing Number"
          value={defaultUserInfo.routingNumber}
        />
        <BankInfoItem
          icon={Hash}
          label="SWIFT Code"
          value={defaultUserInfo.swiftCode}
        />
      </div>
    </Card>
  );
