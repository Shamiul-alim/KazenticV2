...
const UserInfoItem = ({ icon: Icon, label, value }: { icon: any, label: string, value: string }) => (
    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2">
                <UserInfoItem icon={User} label="First Name" value={defaultUserInfo.firstName} />
                <UserInfoItem icon={User} label="Last Name" value={defaultUserInfo.lastName} />
                <UserInfoItem icon={Briefcase} label="Designation" value={defaultUserInfo.designation} />
                <UserInfoItem icon={UserPlus} label="Position" value={defaultUserInfo.position} />
                <UserInfoItem icon={Mail} label="Email" value={defaultUserInfo.email} />
                <UserInfoItem icon={Phone} label="Phone" value={defaultUserInfo.phone} />
            </div>
        </Card>
    )
}
