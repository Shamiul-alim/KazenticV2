...
export default function ProjectDetails() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]  text-[#191F38] tracking-tighter">
      {/* Navbar Section */}
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3.5 gap-4 border-b border-[#EBEBEB] pl-4.75 pr-4.75 h-10">
      ...
      {/* Grid Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5 pl-4.75 pr-4.75">
        {/* LEFT COLUMN */}
          ...
          >
            <div className="h-[300px] w-full relative flex items-center justify-center">
              ...
              <div className="absolute top-[45%] left-[15%] flex items-center bg-white px-3 py-1.5 rounded-lg shadow-[0px_8px_24px_rgba(149,157,165,0.2)] border border-gray-50">
                <span className="text-sm font-bold text-[#F97316]">To Do</span>
                <span className="text-sm font-bold text-[#1E293B] ml-1">
                  2%
                </span>
                {/* Pointer Triangle */}
