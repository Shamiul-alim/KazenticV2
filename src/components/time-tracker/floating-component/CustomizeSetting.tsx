...
export default function CustomizeSection({ onClose }: CustomizeSectionProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute left-53 top-8 z-100 w-70 bg-white border border-[#EBEBEB] rounded-lg shadow-md p-3 animate-in fade-in zoom-in-95 duration-200"
    >
      <div className="space-y-3 text-xs font-medium leading-5 tracking-tight text-[#191F38]">
        <div className="flex items-center justify-between">
          <span>Alit Hassan's Timezone</span>
          <span className="text-[#64748B] ">+06 (UTC+6)</span>
        </div>
        <div className="flex items-center justify-between">
        ...
        <div className="flex items-center  justify-between">
          ...
          <div className="flex w-20 h-8 items-center border border-[#EBEBEB] rounded-lg overflow-hidden ">
