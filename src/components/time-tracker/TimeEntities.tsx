        ...
        <div key={groupIdx} className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between px-1">
            ...
            <div className="flex items-center gap-1 bg-white border border-[#ebebeb] px-2 py-1 rounded-md text-[11px] font-medium shadow-sm">
              <Hourglass size={12} className="text-[#717694]" />
            ...
            <Table>
              <TableHeader className="bg-[#f3f9ff]">
                <TableRow className="border-b border-[#ebebeb] hover:bg-transparent">
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[35%]">Task</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[15%] text-center">Description</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[10%] text-center">Payable</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[10%] text-center">Tags</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[10%] text-center">Signed In</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[10%] text-center">Signed Out</TableHead>
                  <TableHead className="text-[11px] font-semibold text-[#191f38] w-[10%] text-center">Duration</TableHead>
              ...
              <TableBody>
                {rowsPerDay.map((row, idx) => (
                  <TableRow key={idx} className="border-b border-[#ebebeb] last:border-0 hover:bg-slate-50/50 py-0">
                    <TableCell className="py-1 px-4 text-[11px] text-black tracking-tighter">
                      [kzt-242] Create Pages using new design system.
                    </TableCell>
                    
                    <TableCell className="text-center text-slate-400 py-0">-</TableCell>
                    ...
                    <TableCell className="text-center py-1">
                      <span className="px-5 py-1 bg-[#c4fee3] text-black rounded-md text-[11px] font-medium">11:59 AM</span>
                    </TableCell>
                    ...
                    <TableCell className="text-center py-1">
                      <div className="flex items-center gap-2">
                        <Clock size={16} className="text-[#a5541b]" />
