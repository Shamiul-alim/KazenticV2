...
interface SprintBurnSettingsProps {
    isOpen: boolean
    onClose: () => void
    data: any[]
}

export const SprintBurnSettings = ({
    isOpen,
    onClose,
    data,
}: SprintBurnSettingsProps) => {
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <div className="flex-[1.45] bg-[#fcfcfc] border-r border-gray-100 p-8 flex flex-col">
                        ...
                        <div className="flex justify-center gap-8 mt-6">
                            <LegendItem color="#5b6cf9" label="BURNDOWN" />
                        </div>
                    </div>
                            ...
                            {activeTab === "Settings" ? (
                                <>
                                    ...
                                    <Section title="Y-Axis">
                                        <SelectRow label="Measure" value="Effort" icon={<ArrowUpDown />} />
                                        <ArrowRow label="Group by" value="Days" icon={<Layers />} />
                                    </Section>
                                </>
                            ) : (
