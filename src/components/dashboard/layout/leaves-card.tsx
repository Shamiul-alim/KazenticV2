...
export default function LeavesCard() {
    return (
        <CardContainer className="flex-1 text-xs" childrenClassName="grid min-[400px]:grid-cols-2 gap-4" title={<>Leaves <span className="text-xs font-light text-muted-foreground">(Monthly)</span></>}>
            <SummaryCard
                icon={<CalendarDays />}
                label="Annual Leaves"
                value={24}
